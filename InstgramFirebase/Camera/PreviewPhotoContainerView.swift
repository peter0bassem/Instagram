...
class PreviewPhotoContainerView: UIView {
    ...
    let cancelButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleCancelButtobPress(_:)), for: .touchUpInside)
        return button
    }()
    ...
    let saveButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleSaveButtonPress(_:)), for: .touchUpInside)
        return button
    }()
    ...
    @objc func handleCancelButtobPress(_ sener: UIButton) {
        self.removeFromSuperview()
    }
    
    @objc func handleSaveButtonPress(_ sender: UIButton) {
        print("handling save...")
